                    ...
                    <div class="card-body">
                        @foreach ($data as $index => $d)
                            <div class="mt-4">
                                ...
                                <div class="float-end">
                                    ...
                                    <button type="button" data-bs-toggle="modal"
                                        data-bs-target="#viewModal{{ $d->id_materi }}"
                                ...
                                <div class="buttons mt-2">
                                    @if ($d->id_tugas)
                                        ...
                                        <a href="{{ route('guru.listajar.viewTugas', $d->id_tugas) }}"
                                            ...
                                            Tugas Siswa</a>
                                        <a href="{{ route('guru.diskusi.index', $d->id_materi) }}"
                                            class="btn btn-primary d-inline-flex align-items-center">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                                fill="currentColor" class="bi bi-chat-left-dots me-2" viewBox="0 0 16 16">
                                                <path
                                    ...
                                    @else
                                        <button type="button" class="btn btn-primary d-inline-flex align-items-center"
                                            data-bs-toggle="modal" data-bs-target="#tugasModal{{ $d->id_materi }}"><i
                                                class="bi bi-clipboard-plus me-1"></i>Input Tugas</button>
                                    @endif
                                </div>
                                <hr>
                            </div>
                            ...
                            <div class="modal fade text-left" id="viewModal{{ $d->id_materi }}" tabindex="-1"
                                aria-labelledby="myModalLabel33{{ $d->id_materi }}" aria-hidden="true"
                                style="display: none;">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div class="form-group mt-2">
                                                    ...
                                                    <input id="nama" name="nama" type="text"
                                                        placeholder="Nama Materi" value="{{ $d->nama_materi }}"
                                                        class="form-control">
                                                </div>
                                                <label for="floatingTextarea">Deskripsi</label>
                                                <div class="form-group mt-2">
                                                    <textarea class="form-control" name="deskripsi" placeholder="Leave a comment here" id="floatingTextarea">{{ $d->deskripsi }}</textarea>
                                                </div>
                            ...
                            <!--Insert Modal Tugas -->
                            <div class="modal fade text-left" id="tugasModal{{ $d->id_materi }}" tabindex="-1"
                                aria-labelledby="tugasModal{{ $d->id_materi }}" aria-hidden="true">
                                        ...
                                        <form action="{{ route('guru.listajar.storeTugas') }}" method="POST"
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div class="form-group mt-2">
                                                    ...
                                                    <input id="nama" name="nama" type="text"
                                                        placeholder="Nama Tugas" class="form-control">
                                                </div>
                                                <label for="floatingTextarea">Deskripsi</label>
                                                <div class="form-group mt-2">
                            ...
                            <div class="modal fade text-left w-100" id="full-scrn{{ $d->id_materi }}" tabindex="-1"
                                aria-labelledby="myModalLabel20{{ $d->id_materi }}" aria-hidden="true"
                                style="display: none;">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <embed type="application/pdf"
                                                src="{{ url('/assets/tugas/', $d->file_tugas) }}" width="1090"
                                                height="800"></embed>
                                        </div>
                                        <div class="modal-footer">
                                            <button type="button" class="btn btn-light-secondary"
                        ...
                        <div class="form-group">
                            <div class="input-group mb-3">
                                <div class="input-group mb-3">
                                    <label class="input-group-text" for="gambar-input"><i
                                            class="bi bi-upload"></i></label>
                                    <input type="file" class="form-control" name="file[]" id="formFileMultiple"
                                        multiple>
                                </div>
                            </div>
                        </div>
