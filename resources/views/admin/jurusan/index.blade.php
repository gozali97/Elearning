                                ...
                                <tr>
                                    ...
                                    <td>
                                        <button type="button" class="btn btn-sm btn-outline-warning d-inline-flex"
                                            data-bs-toggle="modal" data-bs-target="#inlineForm{{ $d->id_jurusan }}">
                                            <i class="bi bi-pencil-square mt-1"></i> Edit
                                        </button>
                                        <a href="#" class="btn btn-sm btn-outline-danger d-inline-flex"
                                            onclick="event.preventDefault(); confirmDelete({{ $d->id_jurusan }});"><i
                                                class="bi bi-trash-fill mt-1"></i>Hapus</a>
                                    </td>
                                </tr>

                                <!-- Modal view -->
                                <div class="modal fade text-left" id="inlineForm{{ $d->id_jurusan }}" tabindex="-1"
                                    aria-labelledby="myModalLabel33{{ $d->id_jurusan }}" aria-hidden="true"
                                    style="display: none;">
                                    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable"
                                        role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h4 class="modal-title" id="myModalLabel33{{ $d->id_jurusan }}">Edit
                                                    Guru </h4>
                                            ...
                                            <form id="editForm{{ $d->id_jurusan }}" method="POST"
                                                action="{{ route('admin.jurusan.update', $d->id_jurusan) }}"
        ...
        <div class="modal-content">
            ...
            <form action="{{ route('admin.jurusan.store') }}" method="POST">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group mt-2">
                        <input id="nama" name="nama" type="text" placeholder="Nama Jurusan" class="form-control">
                    </div>
                </div>
                <div class="modal-footer">
...
<script>
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            window.location.href = "/jurusan/destroy/" + id;
        }
    });
}
