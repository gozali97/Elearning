                    ...
                    <div class="d-flex justify-content-between mt-2">
                        <div class="">
                            ...
                            <button type="button" class="btn mx-1 btn-outline-success" data-bs-toggle="modal"
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                                    class="bi bi-person-plus-fill d-inline-flex mx-1" viewBox="0 0 16 16">
                                    <path
                        ...
                        <table class="table table-striped" id="table1">
                            ...
                            <tbody>
                                ...
                                <div class="modal fade text-left" id="inlineForm{{ $d->id }}" tabindex="-1"
                                    aria-labelledby="inlineForm{{ $d->id }}" aria-hidden="true">
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <form action="{{ route('admin.manageSiswa.update',$d->id) }}" method="POST"
                                                enctype="multipart/form-data">
                                                @csrf
                                                <div class="modal-body">
                                                    <label for="nama">Nama Siswa: </label>
                                                    <div class="form-group mt-2">
                                                        <input id="nama" name="nama" value="{{ $d->name }}" type="text"
                                                    ...
                                                    <fieldset class="form-group mt-1">
                                                        <select name="kelas" class="form-select" id="basicSelect">
                                                            <option>pilih</option>
                                                            @foreach ($kelas as $k)
                                                            <option value="{{ $k->id_kelas }}" {{ $k->id_kelas == $d->kelas_id ? 'selected' : '' }}>{{ $k->nama_kelas }}
                                                            </option>
                                                            @endforeach
                                                        </select>
                                                    </fieldset>
                                                    ...
                                                    <fieldset class="form-group mt-1">
                                                        <select name="jurusan" class="form-select" id="basicSelect">
                                                            ...
                                                            <option value="{{ $j->id_jurusan }}" {{ $j->id_jurusan == $d->jurusan_id ? 'selected' : '' }}>{{ $j->nama_jurusan }}
                                                            </option>
                                                            @endforeach
                                                        </select>
                                                    </fieldset>
                                                    ...
                                                    <div class="form-group mt-2">
                                                        <input id="email" name="email" value="{{ $d->email }}" type="email"
                                                            placeholder="alamat Email" class="form-control">
                                                    </div>
                                                    <label for="no_hp">No HP: </label>
                                                    <div class="form-group mt-2">
                                                        <input id="no_hp" name="no_hp" value="{{ $d->no_hp }}" type="number" placeholder="No HP"
                                                            class="form-control">
                                                    </div>
                                                    <label for="alamat">Alamat Rumah: </label>
                                                    <div class="form-group mt-2">
                                                        <input id="alamat" name="alamat" value="{{ $d->alamat }}" type="text"
                                                    ...
                                                    <div class="form-group">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-4">
                                                                <img id="preview" src="assets/img/{{$d->gambar}}" alt="">
                                                            </div>
                                                        </div>
